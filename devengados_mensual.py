...
with DAG(dag_id='devengado-mensual',
         default_args=default_args,
         schedule_interval=None) as dag:

    devengado_mensual_task = SparkSubmitOperator(
                    task_id='devengado_mensual_task',
                    conn_id='spark_default',
                    driver_memory='10g',
                    executor_memory='10g',
                    java_class='com.mx.findep.cierre.CierreMensual',
                    application='/data/cierre-devengados-mensual-0.6.0.jar',
